...
const GUIDANCE_SECTION_FIELDS = {
  ...
  recommendations: ['recommendedBatchOptions', 'recommendedInspectOptions', 'recommendedOrganizationOptions', 'workflowPresets', 'batchPolicyGuide', 'configurationRecipes', 'unsupportedFileCategoryCatalog', 'fontIdentityBasisCatalog', 'outputStructureCatalog'],
...
const FONT_IDENTITY_BASIS_CATALOG = Object.freeze({
...
export function getAgentGuidance(args = {}) {
  ...
  const directoryWorkflowExamples = [
    ...
    },
    {
      ...
      mustInspectFields: withDirectoryRouteInspectFields(['sourceSafetyDecision', 'safetySummary', 'operationMode', 'sourceDestructive', 'writesSourceTree', 'writesOutputTree', 'outputTreeInsideInputTree', 'mayOverwriteOutputTree', 'sourceLayoutMismatchSummary.copyOnlyStaging.safePreviewArgs', 'outputStructureDecision', 'auditStatus', 'auditPassed', 'structureSummary']),
