...
async function runBatchIncrementalSmoke() {
...
async function runBatchRunCliSmoke() {
...
async function runBatchIdentityDedupeSmoke() {
...
async function runWorkflowPresetsSmoke() {
...
async function runBatchDryRunSmoke() {
  const ownsFixtureInput = process.argv[3] === undefined;
...
async function runBatchErrorModeSmoke() {
...
async function runBatchDefaultsSmoke() {
