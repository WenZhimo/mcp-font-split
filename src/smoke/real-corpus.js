...
} from './real-corpus-coverage-summary.js';
import {
...
import { summarizeRealCorpusSubprocess } from './real-corpus-subprocess-summary.js';
...
async function runRealCorpusSuiteSmoke() {
  ...
  const coverageSummary = buildRealCorpusSuiteCoverageSummary(runs, {
    ...
    requiredToolCoverage: REQUIRED_REAL_CORPUS_TOOL_COVERAGE,
  });
