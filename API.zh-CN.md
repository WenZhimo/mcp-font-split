...
? `1.0.0` ???`projectStatusNotice.formalRelease` ? `true`??????????????????????????????????????????????????????????????????? `errorType`??????????????????? warning??? resource???????????????????????????
...
- `projectStatusNotice` ??????????????? `formalRelease` ? true????????????????????????????????
  agent ??????????? MCP schema?`get_agent_guidance`?`API.md` / `API.zh-CN.md`?`BEHAVIOR.en.md` / `BEHAVIOR.zh-CN.md` ? release notes ???????
