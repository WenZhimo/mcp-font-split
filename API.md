...
| `sourceLayoutMismatchSummary` | Compact answer for source layout vs recommended grouping, direct original-input safe preview availability, copy-only staging need, and source-safety of staging. |
